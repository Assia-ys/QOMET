...
export const styles = {
  page:             { minHeight: '100vh', background: C.bg, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '70px 16px 20px' },
  ...
  cardsRow:         { display: 'flex', gap: 24, width: '100%', maxWidth: 720, flexWrap: 'wrap' },
  card:             { flex: 1, minWidth: 280, background: C.card, borderRadius: 20, padding: 24, display: 'flex', flexDirection: 'column', gap: 16 },
